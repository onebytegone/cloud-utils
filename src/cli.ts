...
import registerSQSSendMessages from './commands/sqs/send-messages';
...
const dynamodb = program.command('dynamodb')
...
registerSQSSendMessages(sqs.command('send-messages'));
